...
if (isset($_POST['btnupdateorder'])) {
  ...
  // 2) write update quaery for tbl_product add stock.
  ...
  $dalete_invoice_details = $pdo->prepare("delete from tbl_invoice_details where invoice_id =$id");
  $dalete_invoice_details->execute();


  //4)write update quey for tbl_invoice table data.
  ...
  if ($invoice_id != null) {
    ...
    // write select quuery for tbl_product table to get out stock value
    ...
    for ($i = 0; $i < count($arr_pid); $i++) {
      ...
      while ($rowpdt = $selectpdt->fetch(PDO::FETCH_OBJ)) {
        ...
        if ($rem_qty < 0) {
          ...
          //6 : write query for tbl_product table to update stock values.
              ...
              <div class="row">
                ...
                <div class="col-md-4">
                  ...
                  <div class="icheck-danger d-inline">
                    <input type="radio" name="rb" value="Check" id="radioSuccess3" value="Check" <?php echo ($payment_type == 'Check') ? 'checked' : ''  ?>>
