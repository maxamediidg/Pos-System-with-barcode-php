      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="card card-primary card-outline">
              ...
              <h5>Generate Barcode Stickers: </h5>
              </div>
              <div class="card-body">
...
while($row=$select->fetch(PDO::FETCH_OBJ)){
  ...
  <center><p class="list-group-item list-group-item-info"><b>PRODUCT DETAILS</b></p></center>
    ...
    <div class="col-sm-10">          
      <input autocomplete="OFF" type="text" class="form-control" value="'.$row->stock.'" id="rate"  name="rate" readonly>
    </div>
  </div>
  ...
  <image src="productimages/'.$row->image.'" class="img-thumbnail"/>
  </ul>
  </div>
   </div>
