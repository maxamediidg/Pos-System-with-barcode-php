...
<br />
    <div id="page-content" class="page-content">
        <div class="banner">
            <div class="jumbotron jumbotron-bg text-center rounded-0" style="background-image: url('./img/berry.jpg');">
                <div class="container">
                    <h1 class="pt-5 tex-uppercase" style="color: white;">
                        About Us
                    </h1>
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-md-8 text-center mb-3">
                        <h1 class="title text-uppercase mb-2">STAR-MALL</h1>
                        <h5>
                           Pos System In Hargeisa-somaliland
                        </h5>
                    </div>
                    <div class="col-md-10">
                ...
                <div class="row justify-content-center align-items-center mt-3">
                    <div class="col-md-4">
                        <img src="./img/sun.jpg" class="img-fluid">
                    </div>
                    <div class="col-md-6">
                        <h5>
                ...
                <div class="row justify-content-center align-items-center text-right mt-3">
                    ...
                    <div class="col-md-4">
                        <img src="./img/tree.png" class="img-fluid">
                    </div>
                </div>

                <div class="row justify-content-center align-items-center mt-3">
                    <div class="col-md-4">
                        <img src="./img/flower.jpg" class="img-fluid">
                    </div>
                    <div class="col-md-6">
                        <h5>
